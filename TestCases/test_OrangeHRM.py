        ...
        try:
            ...
            for row in range(2,row+1):
                ...
                if Locators().dashboard_url == self.driver.current_url:
                    print("SUCCESS : Login with Username {a} & Password {b}".format(a=test_username, b=test_username))
                    ...
                    print("ERROR : Login unsuccessful with username {a} & Password {b}".format(a=test_username, b=test_username))
